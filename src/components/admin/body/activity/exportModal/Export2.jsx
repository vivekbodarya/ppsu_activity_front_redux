...
const Export2 = (props) => {
    ...
    const exportpdf = () => {
        ...
        // doc.text(`SCHOOL OF ${instAdminReducer.adminProfile.school.name}`, 40, doc.lastAutoTable.finalY + 138);
        // // For sign of Dean
        // doc.text('Dean,', 241, doc.lastAutoTable.finalY + 120);
        // doc.text(`SCHOOL OF ${instAdminReducer.adminProfile.school.name}`, 241, doc.lastAutoTable.finalY + 138);
        // // For sign of COE
