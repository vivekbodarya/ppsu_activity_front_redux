...
const initialState = {
    ...
    //PATCH
    update_student_password_progress: false,
    update_student_password_error: null,
    update_student_password_duplicate: null,

    //status

    // Patch
    update_student_change_password_status_success: false,
